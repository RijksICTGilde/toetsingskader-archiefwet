(function () {
  ...
  var fuseOptions = {
    // Projectoverride van het thema-script: `synoniemen` uit index.json weegt
    // mee, zwaarder dan de titel. Zonder eigen key telde een synoniem even
    // zwaar als elk woord in de tekst en stond norm 6 op "vinden" pas tweede
    // (feedback 25 augustus 2026).
    keys: [
      { name: 'synoniemen', weight: 3 },
      { name: 'title', weight: 2 },
